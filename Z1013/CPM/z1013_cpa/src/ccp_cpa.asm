...
; segment RAM
CLKBCD:		equ	0050h		; BCD-Buffer f¸r CLK orig 50h, z9001 1Dh
COMREC:		equ	007Ch
...
;
;;DISKA		EQU	0004H		;disk address for current disk		; 0003 Z9001, sonst 0004
...
clk:
		ld	hl, CLKBCD
		ld	b, 6		; orig 6, Z9001 nur 3 BCD-Werte (nur Uhr)
clk1:		push	bc
		push	hl
		call	getnumber
		call    sub_CE3E
